...
export default function Header ({ isDark, onToggleTheme, onMenuOpen }) 
    { return ( 
        ...
        flex-wrap gap-3"> 
            <div className="flex items-center gap-4 flex-wrap"> 
                ...
                <select className="bg-gray-700 text-gray-300 px-3 py-1.5 rounded text-sm border border-gray-600 focus:outline-none focus:border-blue-500"> 
                    <option>HTML5</option> 
                    <option>React</option> 
                    <option>Vue</option> 
            ...
            <div className="flex items-center gap-2"> 
                <button className="hidden md:block bg-gray-700 hover:bg-gray-600 text-gray-300 p-2 rounded border border-gray-600 transition"> 
                    <Settings size={16} /> </button> <button className="hidden md:block bg-gray-700 hover:bg-gray-600 text-gray-300 px-2 py-1.5 rounded text-xs border border-gray-600 transition"> 
                        A⁻ A⁺ </button> 
                <button onClick={onToggleTheme} className="bg-gray-700 hover:bg-gray-600 text-gray-300 px-3 py-1.5 rounded flex items-center gap-2 text-sm border border-gray-600 transition" > 
